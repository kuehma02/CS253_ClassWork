...
int main() {
    ...
    Book book1;
    cout << book1.title << " by " << book1.author << " has " << book1.pages << " pages and costs "  << endl; // <<  book1.getPrice() << endl;
    ...
    cout << book1.title << " by " << book1.author << " has " << book1.pages << " pages and costs " << fixed << setprecision(2) << book1.getPrice() << endl;
    printBook(book1);
/*
